...
const ScrollButton = ({ icon, onClick, disabled }: ScrollButtonProps) => {
    ...
    return (
        <button
            type="button"
            className={cx(
                "group inline-flex size-5 truncate rounded-sm transition",
                disabled
...
const Legend = React.forwardRef<HTMLOListElement, LegendProps>((props, ref) => {
    ...
    React.useEffect(() => {
        const keyDownHandler = (key: string) => {
            ...
            if (key === "ArrowRight") scrollToTest("right")
        }
    ...
    }, [enableLegendSlider, checkScroll, categories])
        ...
        <ol ref={ref} className={cx("relative overflow-hidden", className)} {...other}>
            ...
            {enableLegendSlider && (hasScroll?.right || hasScroll?.left) ? (
                <div
                    ...
                    className="absolute bottom-0 right-0 top-0 flex h-full items-center justify-center bg-white pr-1 dark:bg-gray-950"
                >
                    <ScrollButton
    ...
    return (
        ...
        >
            <Legend
                ...
                onClickLegendItem={(category) => onClick?.(category)}
                activeLegend={activeLegend}
                ...
                >
                    ...
                    <Tooltip
                        ...
                        content={({ active, payload, label }) => {
                            ...
                            if (
                                tooltipCallback &&
                                (active !== prevActiveRef.current || String(label) !== prevLabelRef.current)
                            ) {
                                tooltipCallback({
                                    active,
                            ...
                            <React.Fragment key={`group-${category}`}>
                                ...
                                <Area
                                    ...
                                    dot={(dotProps: any) => {
                                        ...
                                        return <React.Fragment key={`empty-dot-${category}-${dotIndex}`} />
                                    }}
                                />
                            </React.Fragment>
                        )
